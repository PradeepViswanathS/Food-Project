...
function Signincard() {
  return (
    <div className='p-5 md:w-[500px] w-[450px]'>
        <div className=' flex flex-col justify-center rounded-lg  p-8 py-8  shadow-black shadow-2xl bg-white'>
            <button className=' shadow-lg shadow-gray-300 p-3 kanit-medium border-[1px]  border-gray-200 hover:bg-gray-100'>Signin with Google</button>
            ...
            <Link to='/' className=' my-3 py-2 kanit-medium text-center  bg-green-500 rounded-md p-1 text-white hover:shadow-md '>Sign In</Link>
            <Link to='/Signup' className=' my-3 py-2 kanit-medium text-center  bg-green-500 rounded-md p-1 text-white hover:shadow-md '>Register</Link>
    </div>
    </div>
  )
}
